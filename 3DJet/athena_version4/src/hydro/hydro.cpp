...
Hydro::Hydro(MeshBlock *pmb, ParameterInput *pin) :
 ...
 U_mean(8,pmb->ncells3, pmb->ncells2, pmb->ncells1),
 U_sum(8,pmb->ncells3, pmb->ncells2, pmb->ncells1),
 U_fluc(4,pmb->ncells3, pmb->ncells2, pmb->ncells1),
 fluc_sum(8,pmb->ncells3, pmb->ncells2, pmb->ncells1),
 Rey_stress(8,pmb->ncells3, pmb->ncells2, pmb->ncells1),
