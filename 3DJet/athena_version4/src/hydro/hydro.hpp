...
class Hydro {
 ...
 public:
  ...
  AthenaArray<Real> U_mean;        // time-integrator memory register #2
  AthenaArray<Real> U_sum;        // time-integrator memory register #2
  AthenaArray<Real> U_fluc;         // fluctuation velocity #1
  AthenaArray<Real> fluc_sum;         // fluctuation sum up velocity #1
  AthenaArray<Real> Rey_stress;         // fluctuation sum up velocity #1
  AthenaArray<Real> T_max;        // time-integrator memory register #3
  AthenaArray<Real> u1, w1;      // time-integrator memory register #4
  AthenaArray<Real> u2;          // time-integrator memory register #5
