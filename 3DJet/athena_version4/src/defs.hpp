...
// problem generator
#define PROBLEM_GENERATOR "jet_wedge"
...
#define COMPILER_COMMAND "mpiicpc"
#define COMPILED_WITH_OPTIONS " -I/powerapps/share/rocky8/hdf5-1.14/include -O3 -std=c++11 -ipo -xhost -inline-forceinline -qopenmp-simd -qopt-prefetch=4 -qoverride-limits -diag-disable=10441 -diag-disable 3180  -L/powerapps/share/rocky8/hdf5-1.14/lib  -lhdf5" // NOLINT
